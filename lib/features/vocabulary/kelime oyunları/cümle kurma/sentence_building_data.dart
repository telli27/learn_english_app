...
class SentenceBuildingDataRepository {
  ...
  SentenceBuildingDataRepository(this._l10n);

  List<SentenceBuildingLevel> get _levels => [
        // Level 1: Beginner - Basic Sentence Structures
        SentenceBuildingLevel(
          id: 'level_1',
          title: 'basic_sentence_structures',
          description: 'simple_sentence_word_order',
          ...
          exercises: [
            ...
            SentenceBuildingExercise(
              ...
              levelId: 'level_1',
              order: 2,
              title: 'present_tense_third_person',
              description: 'build_sentences_third_person',
              targetSentence: 'She goes to school by bus',
              turkishTranslation: _l10n.ex_1_2_translation,
              words: ['She', 'goes', 'to', 'school', 'by', 'bus'],
              distractorWords: ['He', 'walks', 'car', 'train', 'home'],
              grammarFocus: GrammarFocus.presentSimple,
              difficulty: DifficultyLevel.beginner,
              explanation: _l10n.ex_1_2_explanation,
            ...
            SentenceBuildingExercise(
              ...
              levelId: 'level_1',
              order: 3,
              title: 'question_sentences',
              description: 'build_questions_do_does',
              targetSentence: 'Do you like chocolate ice cream',
              turkishTranslation: _l10n.ex_1_3_translation,
              ...
              difficulty: DifficultyLevel.beginner,
              explanation: _l10n.ex_1_3_explanation,
            ...
            SentenceBuildingExercise(
              ...
              levelId: 'level_1',
              order: 4,
              title: 'negative_sentences',
              description: 'build_negative_sentences',
              targetSentence: 'I don\'t watch TV at night',
              turkishTranslation: _l10n.ex_1_4_translation,
              ...
              difficulty: DifficultyLevel.beginner,
              explanation: _l10n.ex_1_4_explanation,
            ...
            SentenceBuildingExercise(
              ...
              grammarRule:
                  'Frequency Adverbs: Subject + Adverb + Verb + Object',
              hints: [
                'Özne "We" ile başlar',
        ...
        SentenceBuildingLevel(
          id: 'level_2',
          title: 'complex_structures',
          description: 'past_future_tense_sentences',
          ...
          exercises: [
            ...
            SentenceBuildingExercise(
              ...
              grammarRule:
                  'Future Plans: Subject + be + going to + Verb + Object',
              hints: [
        ...
        SentenceBuildingLevel(
          id: 'level_3',
          title: 'advanced_grammar',
          description: 'complex_time_structures_conditionals',
  ...
  /// Get all levels
  List<SentenceBuildingLevel> getAllLevels() {
    return List.from(_levels);
  }

  /// Get levels by difficulty
  List<SentenceBuildingLevel> getLevelsByDifficulty(
      DifficultyLevel difficulty) {
    return _levels.where((level) => level.difficulty == difficulty).toList();
  }

  /// Get level by ID
  SentenceBuildingLevel? getLevelById(String id) {
    try {
  ...
  /// Get exercise by ID
  SentenceBuildingExercise? getExerciseById(String exerciseId) {
  ...
  /// Get next level
  SentenceBuildingLevel? getNextLevel(String currentLevelId) {
    final currentIndex =
  ...
  /// Get previous level
  SentenceBuildingLevel? getPreviousLevel(String currentLevelId) {
    final currentIndex =
        _levels.indexWhere((level) => level.id == currentLevelId);
    if (currentIndex <= 0) {
      return null;
  ...
  bool isLevelUnlocked(String levelId, List<String> completedLevels) {
  ...
  List<SentenceBuildingExercise> getExercisesByGrammarFocus(
      GrammarFocus focus) {
  ...
  /// Get localized level with title and description
  SentenceBuildingLevel? getLocalizedLevel(String levelId) {
    final level = getLevelById(levelId);
    if (level == null) return null;

    // Level title and description are already localized via keys
    return SentenceBuildingLevel(
      id: level.id,
      title: _getLocalizedText(level.title),
      description: _getLocalizedText(level.description),
      difficulty: level.difficulty,
      isUnlocked: level.isUnlocked,
      isPremium: level.isPremium,
      grammarTopics: level.grammarTopics,
      exercises:
          level.exercises, // Exercises are already localized in _levels getter
    );
  }

  /// Get localized text for level titles and descriptions
  String _getLocalizedText(String key) {
    switch (key) {
      case 'basic_sentence_structures':
        return _l10n.basic_sentence_structures;
      case 'complex_structures':
        return _l10n.complex_structures;
      case 'advanced_grammar':
        return _l10n.advanced_grammar;
      case 'simple_sentence_word_order':
        return _l10n.simple_sentence_word_order;
      case 'past_future_tense_sentences':
        return _l10n.past_future_tense_sentences;
      case 'complex_time_structures_conditionals':
        return _l10n.complex_time_structures_conditionals;
      case 'present_tense_positive':
        return _l10n.present_tense_positive;
      case 'present_tense_third_person':
        return _l10n.present_tense_third_person;
      case 'question_sentences':
        return _l10n.question_sentences;
      case 'negative_sentences':
        return _l10n.negative_sentences;
      case 'build_simple_present_sentences':
        return _l10n.build_simple_present_sentences;
      case 'build_sentences_third_person':
        return _l10n.build_sentences_third_person;
      case 'build_questions_do_does':
        return _l10n.build_questions_do_does;
      case 'build_negative_sentences':
        return _l10n.build_negative_sentences;
      default:
